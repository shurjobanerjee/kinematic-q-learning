...
def cached_make_env(make_env, **kwargs):
    """
...
def prepare_params(params, **kwargs):
    ...
    def make_env(subrank=None, **kwargs):
    ...
    tmp_env = cached_make_env(params['make_env'], **kwargs)
...
def configure_her(params, **kwargs):
...
def configure_ddpg(dims, params, reuse=False, use_mpi=True, clip_return=True, **kwargs):
